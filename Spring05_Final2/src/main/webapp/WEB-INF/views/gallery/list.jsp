...
<div class="container">
      ...
      <a href="${pageContext.request.contextPath}/gallery/upload_form2">사진 업로드 하러 가기2</a><br>
      <a href="${pageContext.request.contextPath}/gallery/upload_form3">사진 업로드 하러 가기3</a>
      <a href="${pageContext.request.contextPath}/gallery/test_form">ckEditor폼 테스트</a>
      <h1>겔러리 목록 입니다.</h1>
      <div class="row">
               ...
               <div class="card mb-3">
                  <a href="${pageContext.request.contextPath}/gallery/detail?num=${tmp.num}">
                        <div class="img-wrapper">
                           <img class="card-img-top" src="${tmp.imagePath}" />
                        </div>
                  </a>
                  <div class="card-body">
